...
export default function Documentacion() {
  ...
  const [viewProduct, setViewProduct] =
    useState<keyof typeof infoHardware>("Modulo TK-IO22W");
        ...
        <div className="aplicaciones descripcion">
          ...
          <ul className="listOfFeatures flex flex-col gap-[0.5lh]">
            {Object.values(data.listOfFeatures).map((feature, i) => (
              <li className="list-disc pl-[1lh] ml-[10px] mb-[10px]" key={i}>
                {feature}
              </li>
            ))}
          </ul>
  ...
  return (
    <article className="grid grid-cols-[200px_minmax(500px,45vw)_200px] gap-x-[8%] justify-center m-[50px_0px] relative">
            ...
            <button
              ...
              onClick={() => {
                ...
                if (btnModule22w.current && btnModule44w.current) {
                  ...
                  throw new Error(
                    "La referencia 'btnModule22w' o 'btnModule44w' es null o undefined"
                  );
                }
              }}
      ...
      <aside className="sticky top-[150px] self-start">
        ...
        <ul
          className={`listOfNav mt-[10px] flex-col items-start gap-[5px]`}
          ref={listOfNav}
        >
