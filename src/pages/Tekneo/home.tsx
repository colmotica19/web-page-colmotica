            ...
            <section className="funcion-integral txt-conten-center">
                ...
                <div className="container-card">
                    ...
                    <div className="container-card__cards holographic-card">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="inherit" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xmlSpace="preserve" className="fill-white size-[100px]">
                            <g>
