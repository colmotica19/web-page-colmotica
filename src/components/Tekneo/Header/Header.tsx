      ...
      <section className="section-header">
        <div className="pre-header">
          ...
          <button title="Cambiar idioma" name="btnIdioma" className="btnIdioma">
            ...
            <span className="uppercase text-gray-200 text-[16px] font-bold">
              es
            </span>
          </button>
          ...
          <nav className="menuppal">
            <ul>
                ...
                <div className="accordion">
                      ...
                      <NavLink to="controlDeAcceso">
                        ...
                        <div className="containerBodyAndFooterProduct">
                          ...
                          <span className="footerProductItem">
                            Software especializado en gestión y control de
                    ...
                    <li className="productListItem">
                      <NavLink to="tshow">
                        ...
                        <div className="containerBodyAndFooterProduct">
                          ...
                          <span className="footerProductItem">
                            Es una solución tecnológica avanzada para la
                  ...
                  "
                        ...
                        <div className="containerBodyAndFooterProduct">
                          ...
                          <span
                            data-i18n="descripción_nodemaker"
                            className="footerProductItem"
                          >
                            Herramienta de integración diseñada para
                            interconectar dispositivos y sistemas que utilizan
                            distintos protocolos de comunicación, como KNX,
                            Modbus, MQTT y HTTP
                          </span>
                        </div>
                      </NavLink>
              ...
              <li>
                <a href="/Socios/socios.html">Socios</a>
              </li>
              <li>
                <a id="myBtn">Soporte</a>
              </li>
            </ul>
          </nav>
        </div>
            ...
            <section className="selectProduct">
              ...
              >
                ...
                <div className="containerBodyAndFooterProduct">
                  <span className="bodyProductItem">TGate</span>
                  <span
                    data-i18n="descripción_tgate"
                    className="footerProductItem"
                  >
                    Software especializado en gestión y control de accesos,
                    ideal para fortalecer la seguridad en instalaciones de
                    cualquier tamaño.{" "}
                  </span>
                </div>
              </NavLink>
              ...
              >
                ...
                <div className="containerBodyAndFooterProduct">
                  <span className="bodyProductItem">Tshow</span>
                  <span
                    data-i18n="descripción_tshow"
                    className="footerProductItem"
                  >
                    Es una solución tecnológica avanzada para la administración
                    centralizada de archivos multimedia, diseñada para operar en
                    entornos de red privados.
                  </span>
                </div>
              </NavLink>
              <NavLink
              ...
              >
                ...
                <div className="containerBodyAndFooterProduct">
                  ...
                  <span
                    ...
                    className="footerProductItem"
                  >
                    Herramienta de integración diseñada para interconectar
                    dispositivos y sistemas que utilizan distintos protocolos de
                    comunicación, como KNX, Modbus, MQTT y HTTP
                  </span>
                </div>
              </NavLink>
              <NavLink
