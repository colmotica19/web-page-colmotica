...
export function FooterComponent({ page }: { page: "tekneo" | "colmotica" }) {
  ...
  return (
    <>
      <footer>
        <Modal ref={modalRef} className="p-[32px]! min-w-[400px]">
          <div className="flex flex-col gap-[1.5lh]">
            <h1 className="text-3xl">{t("footer_enviar_comentarios")}</h1>
            <form onSubmit={formHandler} className="flex flex-col gap-[1lh]">
              <div className="flex flex-col justify-center items-start gap-[10px] w-full">
                ...
                <input type="text" name="name" id="name" className="border-[1px] p-[4px] border-gray-300 rounded-[4px] focus:outline-gray-400 w-full" />
              </div>
              <div className="flex flex-col justify-center items-start gap-[10px] w-full">
                <label className="text-[14px] text-gray-700" htmlFor="country">{t("footer_pais")}</label>
                <select name="country" title="Selecciona un pais" id="country" className="border-[1px] p-[4px] border-gray-300 rounded-[4px] focus:outline-gray-400 w-full">
              ...
              <div className="flex flex-col justify-center items-start gap-[10px] w-full">
                ...
                <input type="tel" maxLength={13} name="tel" id="tel" className="border-[1px] p-[4px] border-gray-300 rounded-[4px] focus:outline-gray-400 w-full" />
              </div>
              <div className="flex flex-col justify-center items-start gap-[10px] w-full">
                <label className="text-[14px] text-gray-700" htmlFor="email">{t("footer_correo")}</label>
                <input type="email" name="email" id="email" className="border-[1px] p-[4px] border-gray-300 rounded-[4px] focus:outline-gray-400 w-full" />
              </div>
              <div className="flex flex-col justify-center items-start gap-[10px] w-full">
                ...
                <textarea
                  name="comentarios"
                  id="comentarios"
                  className="border-[1px] border-gray-300 rounded-[4px] p-[8px] focus:outline-gray-400 w-full"
                ></textarea>
              </div>
              <button type="submit" title="Envia tus comentarios" className="btnSubmitHelpCenter">
                {t("footer_enviar")}
              </button>
            </form>
          </div>
