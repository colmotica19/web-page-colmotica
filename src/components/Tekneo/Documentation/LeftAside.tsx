        ...
        {buttons.map((btn) => (
          <li key={btn.key} className="w-full">
            <button
              ...
              className={`flex gap-[10px] w-full items-center justify-between p-[8px_12px] btnSection rounded-[8px] hover:text-white text-gray-700 ${activeKey === btn.key ? "!text-white !border-black bg-gray-800" : ""}`}
              type="button"
            >
